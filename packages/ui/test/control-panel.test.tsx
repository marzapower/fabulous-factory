...
import { ControlPanel } from "../src/marketing/control-panel";
...
describe("ControlPanel", () => {
  it("shows a Localization row listing every declared locale with the default annotation, no status dot", () => {
    ...
    // No status dot for this row (unlike every other station's <StatusLight>).
    expect(row!.querySelector(".size-2")).toBeNull();
    // Locale list is styled the same green as an ACTIVE/enabled StatusLight.
