...
/**
 * Constants for the run engine (`packages/untangle/src/runs/`). This half of the
 * milestone is domain-agnostic by design (see `engine.ts`'s header comment) — nothing
 * here knows or cares what a "run" is FOR.
 */
