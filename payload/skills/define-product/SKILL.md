---
name: define-product
description: Interview the human about what this product actually is, fill in PRODUCT.md, and derive the first SPEC from it. Use when PRODUCT.md is still the factory's shipped placeholder, or when the product direction has genuinely changed.
---
