---
name: brand-it
description: Replace the factory's shipped identity, theme, and email copy with your product's own — app name, landing page, colors, transactional email text. Use once you know what the product is (after define-product).
---

# Brand it

This is UI and copy work — if you have a design-focused skill installed, invoke it
alongside this one for aesthetic direction rather than defaulting to the factory's
look unexamined.
