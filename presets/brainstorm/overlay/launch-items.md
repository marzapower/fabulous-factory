...
**Why:** The public `apps/web/app/[locale]/features/` component-docs pages and the demo API
...
- The `apps/web/app/[locale]/features/` directory's docs pages are removed or replaced with
  product content
