...
export const metadata: Metadata = {
  ...
  description:
    "The kernel that makes an unguarded route impossible, this deployment's live capability panel, the same run with the AI switched off, and how to run the template yourself.",
};
          ...
          <section className="mx-auto max-w-6xl px-6 pt-16 pb-4">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Untangle is the sample product that ships with Fabulous Factory, a template for
                building a small SaaS. This page is about the template.
              </p>
              <p className="mt-4 text-lg text-muted-foreground">
