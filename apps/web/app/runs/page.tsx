...
import { getRunForUser, isStaleRun, listRunsForUser, type RunDetail } from "@factory/jobs";
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="font-mono text-xs">
            {run.driver} · {run.startedAt.toLocaleString()} · {formatCents(run.totalCostCents)}
          </CardDescription>
        </CardHeader>
        <CardContent>
