 ...
 * card mid-tilt, exactly as they'd render live in the workbench. `STEPS` and every other
 * string on this page stay hardcoded English (i18n plan D6) — this preset declares a
 * single locale and keeps its product-specific copy untranslated on purpose.
 */
