...
export default async function TermsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      <h1 className="text-3xl font-bold tracking-tight">{tt("heading")}</h1>
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          <h2 className="text-xl font-semibold text-foreground">{tt("section1Title")}</h2>
          <p className="mt-2">{tt("section1Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tt("section2Title")}</h2>
          <p className="mt-2">{tt("section2Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tt("section3Title")}</h2>
          <p className="mt-2">{tt("section3Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tt("section4Title")}</h2>
          <p className="mt-2">{tt("section4Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tt("section5Title")}</h2>
          <p className="mt-2">{tt("section5Body")}</p>
        </section>
      </div>
