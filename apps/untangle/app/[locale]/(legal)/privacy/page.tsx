...
export default async function PrivacyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      <h1 className="text-3xl font-bold tracking-tight">{tp("heading")}</h1>
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          <h2 className="text-xl font-semibold text-foreground">{tp("section1Title")}</h2>
          <p className="mt-2">{tp("section1Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tp("section2Title")}</h2>
          <p className="mt-2">{tp("section2Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tp("section3Title")}</h2>
          <p className="mt-2">{tp("section3Body")}</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">{tp("section4Title")}</h2>
          <p className="mt-2">{tp("section4Body")}</p>
        </section>
      </div>
