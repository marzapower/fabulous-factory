...
export const metadata: Metadata = {
  title: {
    default: "Fabulous Nothing",
    template: "%s · Fabulous Nothing",
  },
  description:
    "The blank-slate Fabulous Factory preset: a landing page, working sign-in and sign-up, and an empty authenticated dashboard. Nothing lives here yet — that's the point.",
};
