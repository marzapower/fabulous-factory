/**
 * Client-side SSE frame parser for `POST /api/runs` (plan K.8.4). Deliberately pure and
 ...
 *
 * The server (`apps/web/app/api/runs/route.ts`) writes one frame per event as
